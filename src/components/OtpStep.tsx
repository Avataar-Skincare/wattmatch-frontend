// Dead code: OTP verification step was removed from the registration flow
// (ConsumerRegisterPage / GeneratorRegisterPage go straight from details to
// review/submit now). Kept here, commented out, in case OTP verification is
// reintroduced later.
//
